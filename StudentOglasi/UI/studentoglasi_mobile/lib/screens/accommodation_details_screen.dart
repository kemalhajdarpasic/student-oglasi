...
import 'package:studentoglasi_mobile/widgets/responsive/accommodation/desktop_accommodations_details_layout.dart';
                    ...
                    children: [
                      ...
                      widget.smjestaj.smjestajnaJedinicas != null &&
                          ...
                          ? ListView.builder(
                              ...
                              itemCount:
                                  widget.smjestaj.smjestajnaJedinicas!.length,
                              itemBuilder: (context, index) {
                                final jedinica =
                                    widget.smjestaj.smjestajnaJedinicas![index];
                                return AccommodationUnitCard(
                                    jedinica: jedinica);
                              },
                            )
                          : Center(
                              child:
                                  Text('Nema dostupnih smještajnih jedinica.'),
                            ),
                    ],
                  ),
                ),
