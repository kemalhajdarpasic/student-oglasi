...
class DesktopInternshipsLayout extends StatelessWidget {
  final List<Praksa> praksa;
  final List<Praksa> recommendedPrakse;
  ...
  const DesktopInternshipsLayout({
    ...
    required this.recommendedPrakse,
                ...
                child: Row(
                  children: [
                    ...
                    Expanded(
                      ...
                      child: ListView(
                        children: [
                          if (recommendedPrakse.isNotEmpty)
                            Padding(
                              padding: const EdgeInsets.all(16.0),
                              child: Text(
                                'Preporučene prakse',
                          ...
                          ...recommendedPrakse.map((praksa) {
                            final averageRating =
                                averageRatings[praksa.id] ?? 0.0;
                            return _buildPostCard(praksa, averageRating, true);
                          }).toList(),
                          if (praksa.isNotEmpty)
                            Padding(
                              padding: const EdgeInsets.all(16.0),
                              child: Text(
                                'Ostale prakse',
  ...
  Widget _buildPostCard(
    ...
    return InkWell(
      onTap: () {
        onCardTap(praksa.id!, averageRating);
      },
      child: Card(
